...
import com.kevinfuture.sort.algorithm.insert.direct.IInsertDirect;
...
import com.kevinfuture.sort.algorithm.radix.IRadix;
import com.kevinfuture.sort.algorithm.radix.impl.RadixImpl;
...
public class test {
    public static void main(String[] args) {
        ...
        try {
            ...
            double[] doubles = new double[]{9.888D,54.6D,23D,7D,123D,4D,33D,123456D};
...
//            System.out.println(quick.sort(doubles,OrderEnum.asc));
            System.out.println(radix.sortByAsc(doubles));
